    ...
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer">
          <div className="flex-1 flex justify-center items-center gap-3 cursor-pointer " onClick={handleProfileChange}>
          <Image
        ...
        <div className="copy_btn " onClick={handleCopy}>
          <Image src={copied === prompt.prompt ? "/assets/icons/tick.svg" : "/assets/icons/copy.svg"} width={12} height={12} alt="copy_btn" />
        </div>
      </div>

      <p className="my-4 font-satoshi text-xs text-gray-700">{prompt.prompt}</p>
